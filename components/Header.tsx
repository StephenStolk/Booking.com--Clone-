          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
              ...
              <Transition
                ...
                enterTo="transition ease-in duration-120"
                ...
                <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                  <div className="p-4">
                    {products.map((item) => {
                      return (
                        <div
                          className="group relative items-center gap-x-5 rounded-lg p-4 text-sm leading-6"
                          key={item.name}
                        >
                          <item.icon className="h-6 w-6 text-sky-800 group-hover:text-blue-600 group-hover:cursor-pointer"></item.icon>
                  ...
                  <div className="grid grid-cols-2 divide-x divide-gray-900/4 bg-gray-30">
                    {callsToAction.map((item) => {
                      return (
                        <a
                          key={item.name}
                          href={item.href}
                          className="flex items-center justify-content gap-x-2.5 p-3 text-sm font-semibold leading-6 text-blue-900"
                        >
                          <item.icon
