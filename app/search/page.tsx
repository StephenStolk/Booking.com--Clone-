...
import { fetchResults } from '@/lib/fetching';
...
async function SearchPage({searchParams}:Props) {
    ...
    if(!results) return <div className="max-w-5xl text-3xl p-5 align-items-center m-auto my-10">
        The Results cannot be published. Your Oxylabs key has been expired. Please set up the key in oxylabs website.
    </div>
              ...
              <div className="flex flex-1 space-x-5 justify-between">
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex items-start justify-end space-x-2 text-right">
                    <div>
                      <p className="font-bold">{item.ratingword}</p>
                      <p className="text-xs">{item.ratingcount}</p>
                    </div>
                  ...
                  <div className="text-right">
                    <p className="text-xs ">{item.bookingdata}</p>
